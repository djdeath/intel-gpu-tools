...
static const uint32_t ps_kernel[][4] = {
   ...
   { 0x02800031, 0x2e0022e8, 0x06000140, 0x08840001 },
   { 0x05800031, 0x200022e0, 0x06000e00, 0x90031000 },
#else
   /* Write all -1 */
...
void gen10_render_copyfunc(struct intel_batchbuffer *batch,
